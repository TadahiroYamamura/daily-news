...
- 英語のタイトルはソースを問わず日本語に翻訳する。Hacker News・Lobsters・セキュリティブログ(aikido.dev/wiz.io)は基本的に英語だが、はてなブックマークIT等の日本語ソースでも紹介先が英語タイトルのプロダクト/記事であるケースがあるため、**source名で判断せず記事ごとに原題が英語かどうかを見て翻訳する**
